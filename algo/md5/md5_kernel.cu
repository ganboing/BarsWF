...
//__constant__
__constant__ unsigned int charset_c[256];// = {0xb182b498, 0xf4d2ac41, 0x1f636569, 0xaf4caf00};
__constant__ unsigned int target_hash[4];// = {0xb182b498, 0xf4d2ac41, 0x1f636569, 0xaf4caf00};
