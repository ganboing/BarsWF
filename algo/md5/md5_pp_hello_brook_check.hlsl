shader: md5_pp_hello_brook_check
...
#line 84 "md5_pp.br"
    val1 = __gather_int (charset, float2(s2)) << 8;
...
#line 94 "md5_pp.br"
      val2 = __gather_int (charset, float2(s1));
...
float2 __vPos: SV_POSITION) : SV_TARGET
{
	__output __o;
	int  output;
	float4 __indexof_output = __vPos - float2(0.5f, 0.5f);
	hello_brook_check(
		k1,
		k2,
		k3,
